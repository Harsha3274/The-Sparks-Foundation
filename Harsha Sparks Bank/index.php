...
<div id="container">
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-family:times new roman;size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to  GRIP
                        Bank!</b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="Bank.PNG" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:black;"><b>Facilities Provided by us</b></h1>
